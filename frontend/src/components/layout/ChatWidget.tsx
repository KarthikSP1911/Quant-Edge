...
export default function ChatWidget() {
  ...
  return (
    <div ref={panelRef} className="fixed bottom-6 right-6 z-[60] flex flex-col items-end gap-3">
      <div
        aria-hidden={!open}
      ...
      <button
        ...
        className="flex h-14 w-14 shrink-0 items-center justify-center rounded-full bg-[var(--color-accent-blue)] text-white shadow-lg transition-transform hover:scale-105 active:scale-95"
      >
        {open ? (
          <svg
            width="22"
