...
function GoogleMark() {
  return (
    <svg
      viewBox="0 0 20 20"
      className="h-full w-full rounded-full border border-[var(--color-border)] bg-white"
      aria-hidden="true"
    >
      <path
        d="M10 10v3.1h4.3c-.2 1.2-1.6 3.4-4.3 3.4-2.6 0-4.7-2.1-4.7-4.7S7.4 6.9 10 6.9c1.5 0 2.5.6 3 1.1l2-2C13.7 4.7 12 4 10 4c-4.4 0-8 3.6-8 8s3.6 8 8 8c4.6 0 7.7-3.2 7.7-7.8 0-.6-.1-1-.1-1.4H10z"
        fill="#4285F4"
      />
      <path d="M2 6.1l2.6 1.9C5.3 6.2 7.4 4.8 10 4.8V2c-3.8 0-7 2.2-8 5.1z" fill="#EA4335" />
      <path
        d="M10 18c2.6 0 4.8-.9 6.4-2.4l-2.6-2c-.7.5-1.7.9-3.8.9-2.9 0-5.4-2-6.3-4.7l-2.6 2C2.5 15.4 6 18 10 18z"
        fill="#34A853"
      />
      <path
        d="M2 12.2A8 8 0 0 1 2 6.1L2 6l2.6 1.9c-.2.6-.3 1.4-.3 2.1 0 .7.1 1.4.3 2.1z"
        fill="#FBBC05"
      />
    </svg>
  )
